...
data_generation_seed = 75
vanilla_trials = 5
vanilla_iterations = 200
vanilla_dir = "result/vanilla_BO_300_runD_data_generation_seed.csv"
vanilla_bo_all_seeds_dir = "result/seeds_runD_data_generation_seed.csv"
our_bo_trial = 5
ours_bo_bound_size = 15
our_bo_iterations = 20
our_bo_samples = [1,2,5,10,20]
our_bo_output_dir = "result/our_bo_30_runD_data_generation_seed"
our_bo_search_method = "multi_search"
run_experiments_all(ground_truth_param,data_generation_seed, vanilla_trials, vanilla_iterations, vanilla_dir, vanilla_bo_all_seeds_dir,
